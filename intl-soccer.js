(function(){
  ...
  // No standings/odds data reliably available across every one of these competitions, so this stays
  // a light formula: broadcast slot, tournament prestige, how close the two teams are in this
  // competition's own table so far, and a retroactive bump for a tight final score or an upset.
